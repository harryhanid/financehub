...
**Date / Tanggal:** 2026-06-10
**Version / Versi:** 1.3
**Status:** Updated — Post Fase 1 + ETF Payment Application + PAM Automation + Status Standardization
...
| **ETF Payment Application** | Tracking 4 tipe PA (AGRI/APP/SML/SETF) dengan 7 SLA dates; auto-link ke PAM number |
...
| **ETF Payment Application (APP/SML)** | ✅ | Extend ke app_pa/sml_pa via `_TAB_CFG`; semua endpoint generik |
...
| **SLA Chip Selection (AGRI/APP/SML)** | ✅ | Chip selection visibility di ETF PA tab |
